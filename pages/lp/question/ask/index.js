...
export default function AskQuestion() {
  ...
  const handlePublish = async () => {
    const res = await fetch("/api/blog/add_blog", {
      method: "POST",
      headers: {
                ...
                <ul role="list" className="space-y-4">
                  ...
                  <li className="bg-white px-4 py-6 shadow sm:rounded-lg sm:p-6">
                    <div>
                      ...
                      >
                        Be specific about what is the post about.
                      </p>
                      <div className="mt-1">
                        <input
                          type="text"
                          ...
                          placeholder="e.g. Kruskal’s Minimum Spanning Tree (MST) Algorithm"
                  ...
                  <li className="bg-white px-4 py-6 shadow sm:rounded-lg sm:p-6">
                    <label
                      ...
                      className="block text-lg font-medium text-gray-700"
                    >
                      What are the details of your post?
                    </label>
                    <p
                      className="mb-2 text-sm text-gray-500"
                  ...
                  <li className="bg-white px-4 py-6 shadow sm:rounded-lg sm:p-6">
                    <div>
                      ...
                      <p
                        ...
                        id="tag-description"
                      >
                        Add up to 5 tags to describe what your post is
